...
3.x and the required libraries installed.1. Environment SetupInstall the necessary Python libraries using the requirements.txt file:Bashpip install -r requirements.txt
